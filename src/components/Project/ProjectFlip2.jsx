...
import projectimage from "../../assets/images/projects/portfolio-4.jpg";
  ...
  return (
    <>
      ...
      <div class="project-container hiddin">
        <a href="https://clone-3dcb7.web.app/" class="project-left">
          ...
          <div class="project-right-content">
            ...
            <h2 className="Project-title">
              <a
                ...
                href="https://clone-3dcb7.web.app/"
              >
                Gmail Clone
              </a>
            </h2>
            <p className="Project-des">
              An absolute clone of the popular email web application - Gmail.
            </p>
            <ul className="tech">
              <li>React</li>
              <li>Tailwind</li>
            ...
            <div className="link">
              <a href="https://github.com/imAshutoshGupta/Gmail-Clone-MERN">
                <svg
              ...
              <a href="https://clone-3dcb7.web.app/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
